...
function t7() {
    ...
    document.querySelector('.out-7').textContent = b
}
...
function t8() {
    ...
    document.querySelector('.out-8').textContent = c;
...
function t9() {
    ...
    document.querySelector('.out-9').textContent = c
...
function t14() {
    let a = document.querySelectorAll('input.i-14');
    let b = '';
    for (let i = 0; i < a.length; i++) {
        if (a[i].checked) {
            b = a[i].value
    ...
    document.querySelector('.out-14').textContent = b
}
