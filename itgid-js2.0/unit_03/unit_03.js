...
function f1() {
    ...
    } else document.querySelector('.out-1').textContent = 'false';
...
function f2() {
    ...
    } else document.querySelector('.out-2').textContent = a22
}
...
function f3() {
    ...
    if (a > b) document.querySelector('.out-3').textContent = a;
    else document.querySelector('.out-3 ').textContent = b;
}
...
function f5() {
    ...
    document.querySelector('.out-5').textContent = b;
...
function f6() {
    ...
    document.querySelector('.out-6').textContent = b;
}
...
function f7() {
    ...
    //  let c = Math.pow(a, b)
    let c = a ** b
    document.querySelector('.out-7').textContent = c;
}
...
function f8() {
    let a = +document.querySelector('select.s-8').value;
    let b;
    switch (a) {
        case 1:
            b = "one";
    ...
    document.querySelector('.out-8').textContent = b;
}
...
function f9() {
    ...
    document.querySelector('.out-9').textContent = b
}
...
function f10() {
    document.querySelector('.out-10').textContent = document.querySelector('.s-100').value
...
function f11() {
    ...
    document.querySelector('.out-11').textContent = document.querySelector('.s-110').value
...
function f13() {
    let a = document.querySelector('input.i-130').value;
...
function f14() {
    ...
    document.querySelector('.out-14').textContent = d;
...
function f15() {
    ...
    document.querySelector('.out-15').textContent = c;
