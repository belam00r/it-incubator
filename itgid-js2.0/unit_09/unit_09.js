...
function f1() {
    let a = document.querySelector('.out-1').style;
    a.width = "200px"
    a.height = '90px'
}
...
function f5() {
    ...
    let b = document.querySelector(".out-4").classList
    if (b.contains('bg-orange')) {
        a.innerHTML = "true"
    } else {
        a.innerHTML = "false"
    }
...
function f6() {
    let out_6 = document.querySelectorAll('p')
    document.querySelector('.out-6').innerHTML = out_6.length
}
...
let a = document.querySelectorAll('.out-10')
for (i = 0; i < a.length; i++) {
    // a[i].classList.toggle('bg-orange')
    a[i].onclick = f10
}
...
function f13() {
    let pushMe = document.createElement('div')
    pushMe.classList.add('bg-orange')
    pushMe.textContent = "pushMe"
    pushMe.onclick = f13_1
    document.querySelector('.out-13').append(pushMe)
}
...
function f14() {
    ...
    document.querySelector('.out-14').append(newDiv)
}
...
function f18() {
    let p_18 = document.querySelector('.p-18').getAttribute('data-b')
    document.querySelector('.out-18').textContent = p_18
}
...
function f19() {
    ...
    for (let i = 0; i < p_19.length; i++) {
        newText += p_19[i].getAttribute('data-b') + " "
    }
    document.querySelector('.out-19').textContent = newText
}
