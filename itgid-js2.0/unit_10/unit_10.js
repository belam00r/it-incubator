...
function f1() {
    let firstArray = ["Vova", 22, true]
    document.querySelector('.out-1').textContent = firstArray
...
let ar6 = ["Vladimir", "Scorpion", 1, 'ноябрь']
...
function f10() {
    let summ = ar9[0] + ar9[ar9.length - 1]
    document.querySelector('.out-10').innerHTML = summ
}
...
function f16() {
    ...
    document.querySelector('.out-16-odd').innerHTML = strOdd
    document.querySelector('.out-16-even').innerHTML = strEven
