...
function f11() {
    let inNum = d11.indexOf(+document.querySelector('.i-11').value)
    document.querySelector('.out-11').textContent = inNum
}
...
function f12() {
    let inNum = ""
    let index = +document.querySelector('.i-12').value
    for (let i = 0; i < d12.length; i++) {
        if (index == d12[i]) {
            inNum = i
            break;
        } else if (i == d12.length - 1) {
            inNum = -1
        }
    }
    document.querySelector('.out-12').textContent = inNum
}
...
function f14() {
    let key = +document.querySelector('.i-14').value
    for (let i = 0; i < key; i++) {
        d14.push(1)
    }
    showArr('.out-14', d14);
...
function f15() {
    let k = +document.querySelector('.i-15').value
...
function f18() {
    let key = document.querySelector('.i-18').value
    let out = ""
    out = d18.includes(key)
