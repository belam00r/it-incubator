...
let e1 = '3';
let f1 = 5;
document.querySelector('.out-4').textContent = e1 + f1 // Произошла конкатенация, тк e1 это строка
...
function t9() {
    let value = document.querySelector('input.i-9').value;
    document.querySelector('div.out-9').textContent = value;
    //document.querySelector('input.i-9').value = ""; // почему так работает очистка input?
    console.log(value)
    value = ""; // так не работает ??
    console.log(value)
...
function t10() {
    let b10 = document.querySelector('input.i-10');
    document.querySelector('div.out-10').textContent = (b10.value) * 20;
    b10.value = '';
}
...
function t11() {
    ...
    document.querySelector('.out-11').textContent = i11 + 55;
}

document.querySelector('.b-11').onclick = t11;
let inputName = document.querySelector('.i-12-1').value;
let inputLastName = document.querySelector('.i-12-2').value;
document.querySelector('.out-12 ').textContent = "Hello " + inputName + " " + inputLastName;
...
function t13() {
    let a = document.querySelector('input.i-13-1').value;
    let b = document.querySelector('input.i-13-2').value;
    document.querySelector('.out-13').textContent = +b + (+a)
...
function t14() {
    document.querySelector('input.i-14').value = 'Go'
}
...
function t16() {
    document.querySelector('.out-16').textContent = document.querySelector('.i-16-1').value + document.querySelector('.i-16-2').value;
}
