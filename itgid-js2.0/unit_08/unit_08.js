...
function t5() {
    ...
    let num = ""
    while (i < 18) {
        if (i % 2 == 0) { num += `${i}_**` } else { num += `${i}_*` }
        i++
    }
    document.querySelector('.out-5').textContent = num
}
...
function t6() {
    ...
    document.querySelector('.out-6').innerHTML = k
}
...
function t7() {
    ...
    document.querySelector('.out-7').innerHTML = j
...
function t8() {
    ...
    document.querySelector('.out-8').innerHTML = k
...
function t10() {
    ...
    document.querySelector('.out-10').textContent = c
}
...
function t11() {
    ...
    document.querySelector('.out-11').textContent = b
}
...
function t14() {
    ...
    while (i < a.length) {
        if (a[i].checked) {
            document.querySelector('.out-14').textContent = a[i].value
        }
        i++
    }
}
