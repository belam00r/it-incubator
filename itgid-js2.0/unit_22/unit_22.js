...
function t3() {
    ...
    try {
        ...
        console.log("Создаем div");
        document.querySelectorAll('section')[2].append(div);
        console.log('вставляем div');
        console.log(document.querySelectorAll('section>div'))
        document.querySelectorAll('section>div')[2].classList.add('out-3');
        console.log("добавляем class \"out-3\"")
    } finally {
        console.log("вставляем a*b")
        document.querySelector('.out-3').innerHTML = a * b;
    }
}
