...
const f6 = () => {
    let a6Array = new Set(a6)
    console.log(a6Array.size)
}
...
const f7 = () => {
    ...
    let out = 1
    console.log(setValue.size != value.length || value.length < 6)
    if (setValue.size != value.length || value.length < 6) {
        out = 0
    }
