...
function f4() {
    let a = document.querySelector('div.out-4');
    let b;
...
function f5() {
    if (document.querySelector('.i-5').checked) document.querySelector('.out-5').textContent = document.querySelector('.i-5').value
    else document.querySelector('.out-5').textContent = "false";
}
...
function f7() {
    ...
    let b = document.querySelector('.out-71')
    let c = document.querySelector('.out-72')
    b.textContent = a
    if (a.length >= 6) {
        c.textContent = 1
    } else {
...
function f9() {
    ...
    } else document.querySelector('.out-9').textContent = 'false';
...
function f15() {
    ...
    document.querySelector('.t-15').value = a;
...
function f16() {
    document.querySelector('.out-16').textContent = document.querySelector('.s-16').value
...
function f17() {
    document.querySelector('.out-17').textContent = document.querySelector('.s-17').value
...
function f19() {
    let a = document.querySelector('.out-19').textContent
