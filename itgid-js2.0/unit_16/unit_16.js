...
function f3() {
    for (let i = 0; i < document.getElementsByClassName("out-3").length; i++) {
        document.getElementsByClassName("out-3")[i].innerHTML = 3
    }
}
...
function f4() {
    for (let k of document.querySelectorAll(".out-4")) {
        k.textContent = 4
    }
}
...
function f15() {
    let element = document.querySelectorAll(".out-15")
        // console.log(element)
